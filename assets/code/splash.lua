...
function splashScreen ()
  ...
  splashDeck:setTexture ( "../images/moai_splash.png" )
  ...
  splash:setLoc ( 0, 0 )
  layers[LAYER_TOP]:insertProp ( splash )
  ...
  curve:reserveKeys ( 4 )
  curve:setKey ( 1, 0.0, 0.0 , MOAIEaseType.EASE_IN )
  curve:setKey ( 2, fade_in, 1.0, MOAIEaseType.EASE_OUT )
  curve:setKey ( 3, fade_in + hold, 1.0, MOAIEaseType.EASE_IN )
  curve:setKey ( 4, length, 0.0, MOAIEaseType.EASE_OUT )
...
--  splash:setAttrLink ( MOAIColor.ATTR_A_COL, curve, MOAIAnimCurve.ATTR_VALUE )
  ...
  layers[LAYER_TOP]:removeProp ( splash )

--  printf ("after splash screen\n")
end
